...
<!-- font-size 를 조절하면 원하는 크기로 글자를 조절할 수 있습니다.-->
  ...
  <div key="1">
    <img src=http://mazassumnida.wtf/api/v2/generate_badge?boj=kyum8562 width="280" height="140" alt="baekjoon" />
    <img src=http://mazandi.herokuapp.com/api?handle=kyum8562&theme=dark width="285" height="140" alt="solved" />
  </div>
  
  <div key="6">
    <a href = "https://oreuda.kr/">
      <img
        src=https://oreuda.kr/api/v1/plant/card?nickname=kyum8562
        alt="oreuda"
      />
    </a>
  </div>
  ...
  <h3 style ="font-size : 2em; font-weight:700;">🍀Tech Stack🍀</h3>
    <div ><h3 key=0 style ="font-size : 1.5em; font-weight:700;">프론트엔드</h3><div "><img
        ...
        /></div><h3 key=1 style ="font-size : 1.5em; font-weight:700;">협업 툴</h3><div "><img
          key=698362.3808225356
          style = "margin: 5px 5px;"
          src=https://img.shields.io/badge/git-F05032?style=flat&logo=git&logoColor=white
          alt=""
        /> <img
          key=533564.4883521349
          style = "margin: 5px 5px;"
        ...
        /></div><h3 key=2 style ="font-size : 1.5em; font-weight:700;">디자인</h3><div "><img
          key=649377.365550313
          style = "margin: 5px 5px;"
          src=https://img.shields.io/badge/figma-F24E1E?style=flat&logo=figma&logoColor=white
          alt=""
        /></div><h3 key=3 style ="font-size : 1.5em; font-weight:700;">테스트</h3><div "><img
          key=275094.2828202333
          style = "margin: 5px 5px;"
          src=https://img.shields.io/badge/typescript-31859c?style=flat&logo=typescript&logoColor=white
          alt=""
        /> <img
          key=777622.5364435269
          style = "margin: 5px 5px;"
          src=https://img.shields.io/badge/objective-c-438eff?style=flat&logo=objective-c&logoColor=white
          alt=""
        /></div></div>
  </div>
  ...
  <div key="7" >
    <div key=0 >
          ...
          <p style ="font-size : 20px;">새로움 뿐만 아니라, 기존의 불편한 점을 찾고 개선하는 개발자가 되고 싶습니다.</p>
    </div>
  </div>
